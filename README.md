...
`docs/40_iterations/Experiment_Queue.md` 是 WF10 的 durable backlog：记录下一轮实验问题、falsifier、control、paper-driven run request 和 Assurance Axis 缺口。`docs/45_discoveries/Research_Wiki.md` 是研究者可搜索的发现索引，存放 observations、method notes、paper context、open questions 和已被 Source Artifact 支撑的 findings；它不是 Approved Contract。
