...
type ProviderConfig struct {
	...
	Priority     int               // higher value = preferred earlier during auto failover
	CooldownSec  int               // provider cooldown after exhaustion; 0 = default
	AutoFailover *bool             // nil = enabled by default
}
