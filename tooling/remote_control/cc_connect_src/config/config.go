...
type ProjectConfig struct {
	...
	HarnessCards     HarnessCardConfig `toml:"harness_cards"`
...
type HarnessCardConfig struct {
	Enabled                          *bool  `toml:"enabled,omitempty"`
	HomeTitle                        string `toml:"home_title,omitempty"`
	ShowWorkspaceRoot                *bool  `toml:"show_workspace_root,omitempty"`
	ShowMetric                       *bool  `toml:"show_metric,omitempty"`
	ShowAccount                      *bool  `toml:"show_account,omitempty"`
	ShowRecommendedActions           *bool  `toml:"show_recommended_actions,omitempty"`
	ShowCopyableCommands             *bool  `toml:"show_copyable_commands,omitempty"`
	ProviderCardShowCopyableCommands *bool  `toml:"provider_card_show_copyable_commands,omitempty"`
	ModelCardShowCopyableCommands    *bool  `toml:"model_card_show_copyable_commands,omitempty"`
	ReasoningCardShowCopyableCommands *bool `toml:"reasoning_card_show_copyable_commands,omitempty"`
	InteractionHint                 string `toml:"interaction_hint,omitempty"`
}
...
type ProviderConfig struct {
	...
	AutoFailover *bool                 `toml:"auto_failover,omitempty"`
}
	...
	if len(in.Providers) > 0 {
		...
		for i := range in.Providers {
			out.Providers[i] = ProviderConfig{
				...
				Priority:     in.Providers[i].Priority,
				CooldownSec:  in.Providers[i].CooldownSec,
				AutoFailover: in.Providers[i].AutoFailover,
			}
		}
	}
	return out
