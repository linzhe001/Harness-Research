---
name: code-review
description: Review code and code-backed docs with line-referenced findings, git metadata, Codex review, optional DeepSeek cross-check, and a reconciled report.
...
5. Attempt Codex review through the available Codex review surface, such as a
   ...
   DeepSeek v4 Pro review when available. Record `NOT_RUN` with a reason when
   either reviewer is unavailable.
